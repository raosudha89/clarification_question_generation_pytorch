...
#SBATCH --job-name=create_crowdflower_HK_beam_batch2
#SBATCH --output=create_crowdflower_HK_beam_batch2
#SBATCH --qos=batch
#SBATCH --mem=32g
#SBATCH --time=4:00:00
...
python $SCRIPT_DIR/create_crowdflower_data.py  --qa_data_fname $CORPORA_DIR/qa_${SITENAME}.json.gz \
                                                ...
                                                --prev_batch_csv_file $CROWDFLOWER_DIR/crowdflower_lucene_seq2seq_rl_gan_diverse_beam_epoch8.batch1.csv \
                                                --csv_file $CROWDFLOWER_DIR/crowdflower_lucene_seq2seq_rl_gan_beam_epoch8.batch2.csv \
                                                ...
                                                --rl_model_name RL_selfcritic.epoch8.beam \
                                                --rl_model_fname $DATA_DIR/blind_test_pred_question.txt.RL_selfcritic.epoch8.len_norm.beam0 \
                                                --gan_model_name GAN_selfcritic_pred_ans_3perid.epoch8.beam \
