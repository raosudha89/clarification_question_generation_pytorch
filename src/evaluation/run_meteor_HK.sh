...
TEST_SET=blind_test_pred_question.lucene.txt
#TEST_SET=blind_test_pred_ques.txt.seq2seq.epoch100.beam0.nounks
#TEST_SET=blind_test_pred_ques.txt.RL_mixer_3perid.epoch5.beam0.nounks
#TEST_SET=blind_test_pred_ques.txt.GAN_selfcritic_pred_ans_3perid.epoch8.beam0.nounks
